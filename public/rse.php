...
<main id="main-content">
    ...
    <div class="page-hero">
        <div class="max-w-4xl mx-auto px-4">
            <h1><i class="fa-solid fa-leaf text-emerald-400" aria-hidden="true"></i><?= e($pageTitle) ?></h1>
        ...
        <div class="max-w-7xl mx-auto px-4 space-y-8">
            ...
            <div class="glass-card-static p-6" id="rse-engagement-social">
                <div class="flex items-center gap-3 mb-6">
                    <i class="fa-solid fa-handshake text-emerald-400 text-2xl" aria-hidden="true"></i>
                    <div>
                ...
                <?php else: ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <a href="page.php?slug=<?= e($i['slug']) ?>" class="glass-card p-5 flex gap-4 items-start reveal">
                            ...
                            <?php else: ?>
                            <i class="fa-solid fa-handshake text-emerald-400 text-xl shrink-0 mt-1" aria-hidden="true"></i>
                            <?php endif; ?>
                            <div>
            ...
            <div class="glass-card-static p-6" id="rse-engagement-environmental">
                <div class="flex items-center gap-3 mb-6">
                    <i class="fa-solid fa-seedling text-emerald-400 text-2xl" aria-hidden="true"></i>
                    <div>
                        <h2 class="text-xl font-bold text-white"><?= e($title) ?></h2>
                        <p class="text-sm text-emerald-200/50"><?= e($subtitle) ?> — <strong><?= $count ?></strong> <?= $itemWord ?></p>
                    </div>
                ...
                <?php else: ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <a href="page.php?slug=<?= e($i['slug']) ?>" class="glass-card p-5 flex gap-4 items-start reveal">
                            ...
                            <img src="<?= e(upload_url($i['featured_image'])) ?>" alt="" class="w-16 h-16 object-cover rounded-lg shrink-0" loading="lazy">
                            <?php else: ?>
                            <i class="fa-solid fa-seedling text-emerald-400 text-xl shrink-0 mt-1" aria-hidden="true"></i>
                            <?php endif; ?>
                            <div>
                                <h3 class="font-semibold text-white mb-2"><?= e($i['t']) ?></h3>
                                <?php if (!empty($i['s'])): ?><p class="text-sm text-emerald-200/70"><?= e(excerpt($i['s'], 200)) ?></p><?php endif; ?>
            ...
            <div class="glass-card-static p-6" id="rse-rapport-durabilite">
                <div class="flex items-center justify-between gap-3 mb-6">
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-chart-bar text-emerald-400 text-2xl" aria-hidden="true"></i>
                        <div>
                ...
                <?php else: ?>
                    ...
                    <div class="mb-6">
                        <h3 class="text-base font-semibold text-emerald-300 mb-3 flex items-center gap-2">
                            <i class="fa-solid fa-file-lines text-emerald-400" aria-hidden="true"></i>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <a href="page.php?slug=<?= e($i['slug']) ?>" class="glass-card p-5 flex gap-4 items-start reveal">
                                ...
                                <img src="<?= e(upload_url($i['featured_image'])) ?>" alt="" class="w-16 h-16 object-cover rounded-lg shrink-0" loading="lazy">
                                <?php else: ?>
                                <i class="fa-solid fa-file-lines text-emerald-400 text-xl shrink-0 mt-1" aria-hidden="true"></i>
                                <?php endif; ?>
                                <div>
                    ...
                    <div class="mb-6">
                        <h3 class="text-base font-semibold text-emerald-300 mb-3 flex items-center gap-2">
                            <i class="fa-solid fa-book-open text-emerald-400" aria-hidden="true"></i>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <a href="page.php?slug=<?= e($i['slug']) ?>" class="glass-card p-5 flex gap-4 items-start reveal">
                                ...
                                <img src="<?= e(upload_url($i['featured_image'])) ?>" alt="" class="w-16 h-16 object-cover rounded-lg shrink-0" loading="lazy">
                                <?php else: ?>
                                <i class="fa-solid fa-book-open text-emerald-400 text-xl shrink-0 mt-1" aria-hidden="true"></i>
                                <?php endif; ?>
                                <div>
                                    <h4 class="font-semibold text-white mb-2"><?= e($i['t']) ?></h4>
                                    <?php if (!empty($i['s'])): ?><p class="text-sm text-emerald-200/70"><?= e(excerpt($i['s'], 200)) ?></p><?php endif; ?>
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-emerald-300 mb-3 flex items-center gap-2">
                            <i class="fa-solid fa-chart-bar text-emerald-400" aria-hidden="true"></i>
                            <?= e($durTitle) ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <a href="page.php?slug=<?= e($i['slug']) ?>" class="glass-card p-5 flex gap-4 items-start reveal">
                                ...
                                <img src="<?= e(upload_url($i['featured_image'])) ?>" alt="" class="w-16 h-16 object-cover rounded-lg shrink-0" loading="lazy">
                                <?php else: ?>
                                <i class="fa-solid fa-chart-bar text-emerald-400 text-xl shrink-0 mt-1" aria-hidden="true"></i>
                                <?php endif; ?>
                                <div>
                                    <h4 class="font-semibold text-white mb-2"><?= e($i['t']) ?></h4>
                                    <?php if (!empty($i['s'])): ?><p class="text-sm text-emerald-200/70"><?= e(excerpt($i['s'], 200)) ?></p><?php endif; ?>
