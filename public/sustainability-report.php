...
<main id="main-content">
    ...
    <div class="page-hero">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <h1 class="mt-2"><i class="fa-solid fa-chart-bar text-emerald-400" aria-hidden="true"></i><?= e($pageTitle) ?></h1>
        ...
        <div class="max-w-7xl mx-auto px-4 space-y-10">
            ...
            <div class="sr-section" id="sr-<?= $catKey ?>">
                ...
                <div class="sr-section-header">
                    <div class="sr-section-icon" aria-hidden="true"><i class="fa-solid <?= e($meta['icon']) ?> text-emerald-400"></i></div>
                    <div>
                ...
                <?php if (empty($items)): ?>
                <div class="sr-empty">
                    <div class="sr-empty-icon" aria-hidden="true"><i class="fa-solid <?= e($meta['icon']) ?> text-emerald-400"></i></div>
                    <p><?= $noResults ?></p>
                </div>
                ...
                <div class="sr-grid">
                    ...
                    <a href="page.php?slug=<?= e($i['slug']) ?>" class="sr-card">
                        ...
                        <div class="sr-card-thumb sr-card-thumb-placeholder" aria-hidden="true">
                            <i class="fa-solid <?= e($meta['icon']) ?> text-emerald-400 text-xl"></i>
                        </div>
                        <?php endif; ?>
