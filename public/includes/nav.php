    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <a href="index.php" class="flex items-center gap-2 text-white font-bold text-lg" aria-label="<?= e(APP_NAME) ?> — <?= $lang === 'ar' ? 'الصفحة الرئيسية' : ($lang === 'fr' ? 'Accueil' : 'Home') ?>">
                <img src="assets/logo-sepj.png" alt="SEPJ Gabès logo" class="h-16 w-auto" aria-hidden="true">
            ...
            <div class="desktop-nav flex items-center gap-1" role="list">
                ...
                $langMeta = [
                    ...
                    'fr' => ['label' => 'Français',   'flag' => 'assets/fr1.png', 'alt' => 'France'],
                    'en' => ['label' => 'English',    'flag' => 'assets/uk1.png', 'alt' => 'UK'],
                ];
            ...
            <!-- Mobile-only controls: theme toggle stays visible next to the
                 hamburger at all times, instead of being tucked inside the
                 mobile menu list. -->
            <div class="flex items-center gap-1">
                <button id="themeToggleMobileBar"
                        class="theme-toggle nav-mobile-theme-toggle"
                        role="switch"
                        aria-checked="false"
                        aria-label="<?= $lang === 'ar' ? 'تفعيل الوضع الفاتح' : ($lang === 'fr' ? 'Passer en mode clair' : 'Switch to light mode') ?>">
                    <span class="theme-toggle-track" aria-hidden="true">
...
<!-- Mobile Menu — must live OUTSIDE .navbar: its backdrop-filter makes the navbar
     the containing block for fixed descendants on mobile browsers, which would
     collapse this full-screen overlay into the 64px navbar strip -->
<div id="mobileMenu"
     class="mobile-menu"
     role="dialog"
     aria-modal="true"
