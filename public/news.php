...
<main id="main-content">
    <div class="page-hero">
        <div class="max-w-7xl mx-auto px-4">
            <h1><i class="fa-solid fa-newspaper text-emerald-400" aria-hidden="true"></i><?= __('nav_news', $lang) ?></h1>
        </div>
    </div>
    ...
    <section class="py-8 relative z-10">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="empty-state">
                <div class="empty-state-icon" aria-hidden="true"><i class="fa-solid fa-newspaper"></i></div>
                <p><?= __('no_results', $lang) ?></p>
            </div>
            <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php foreach ($items as $i): ?>
                <a href="page.php?slug=<?= e($i['slug']) ?>" class="glass-card overflow-hidden group reveal">
