...
<main id="main-content">
    <div class="page-hero"><div class="max-w-4xl mx-auto px-4">
        ...
        <form method="GET" role="search" class="mt-6 max-w-xl mx-auto">
            <div class="flex gap-2">
                ...
                <button type="submit" class="glass-btn"><i class="fa-solid fa-magnifying-glass" aria-hidden="true"></i><?= __('search', $lang) ?></button>
            </div>
        </form>
    </div></div>
    <section class="py-8 relative z-10">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <?php if (empty($results)): ?><div class="empty-state"><div class="empty-state-icon"><i class="fa-solid fa-magnifying-glass"></i></div><p><?= __('no_results', $lang) ?></p></div>
            <?php else: ?>
