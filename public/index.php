...
<main id="main-content">
    ...
    <section class="hero-section">
        <div class="max-w-5xl mx-auto px-4 text-center relative z-10">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="news.php" class="glass-btn glass-btn-primary">📰 <?= __('nav_news', $lang) ?></a>
                <a href="projects.php" class="glass-btn">🏗️ <?= __('nav_projects', $lang) ?></a>
                <a href="contact.php" class="glass-btn">📞 <?= __('nav_contact', $lang) ?></a>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 relative z-10">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="glass-card stat-card"><div class="stat-number"><?= e(get_setting('stat_founded_value')) ?></div><div class="stat-label"><?= e(get_setting('stat_founded_label', $lang) ?: __('founded', $lang)) ?></div></div>
                <div class="glass-card stat-card"><div class="stat-number"><?= e(get_setting('stat_trees_value')) ?>+</div><div class="stat-label"><?= __('trees_planted', $lang) ?></div></div>
                <div class="glass-card stat-card"><div class="stat-number"><?= e(get_setting('stat_hectares_value')) ?>+</div><div class="stat-label"><?= __('hectares_transformed', $lang) ?></div></div>
                <div class="glass-card stat-card"><div class="stat-number"><?= e(get_setting('stat_activation_value')) ?></div><div class="stat-label"><?= __('activation_rate', $lang) ?> <?= e(get_setting('stat_activation_year')) ?></div></div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 relative z-10">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between mb-8">
                <h2 class="section-title mb-0">📰 <?= __('latest_news', $lang) ?></h2>
    ...
    <section class="py-16 relative z-10">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between mb-8">
                <h2 class="section-title mb-0">🏗️ <?= __('our_projects', $lang) ?></h2>
    ...
    <section class="py-16 relative z-10">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between mb-8">
                <h2 class="section-title mb-0">📋 <?= __('our_activities', $lang) ?></h2>
    ...
    <!-- Contact CTA -->
    <section class="py-16 relative z-10">
        <div class="max-w-4xl mx-auto px-4 text-center glass-card-static p-8">
            <h2 class="text-2xl font-bold text-white mb-4"><?= __('contact_us', $lang) ?></h2>
            <div class="flex flex-wrap justify-center gap-6 text-emerald-200/80 mb-6">
                <span>📞 <?= e($phone) ?></span>
                <span>📧 <?= e($email) ?></span>
                <span>📍 <?= e($address) ?></span>
            </div>
            <a href="contact.php" class="glass-btn glass-btn-primary"><?= __('send_message', $lang) ?></a>
        </div>
    </section>
</main>
