...
<main id="main-content">
    <div class="page-hero"><div class="max-w-7xl mx-auto px-4"><h1><span aria-hidden="true">🖼️</span> <?= __('photo_gallery', $lang) ?></h1></div></div>
    <section class="py-8 relative z-10">
        <div class="max-w-7xl mx-auto px-4">
            <?php if (empty($images)): ?><div class="empty-state"><div class="empty-state-icon" aria-hidden="true">🖼️</div><p><?= __('no_results', $lang) ?></p></div>
            <?php else: ?>
