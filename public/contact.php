        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="glass-card-static p-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3"><i class="fa-solid fa-location-dot text-emerald-400 text-lg mt-1 shrink-0" aria-hidden="true"></i><div><p class="text-white font-medium"><?= $lang === 'ar' ? 'العنوان' : ($lang === 'fr' ? 'Adresse' : 'Address') ?></p><p class="text-emerald-200/70"><?= e(get_setting('address', $lang)) ?></p></div></div>
                        <div class="flex items-start gap-3"><i class="fa-solid fa-phone text-emerald-400 text-lg mt-1 shrink-0" aria-hidden="true"></i><div><p class="text-white font-medium"><?= $lang === 'ar' ? 'الهاتف' : ($lang === 'fr' ? 'Téléphone' : 'Phone') ?></p><p class="text-emerald-200/70"><?= e(get_setting('phone')) ?></p></div></div>
                        <div class="flex items-start gap-3"><i class="fa-solid fa-envelope text-emerald-400 text-lg mt-1 shrink-0" aria-hidden="true"></i><div><p class="text-white font-medium">Email</p><p class="text-emerald-200/70"><?= e(get_setting('email_primary')) ?><br><?= e(get_setting('email_secondary')) ?></p></div></div>
                        <div class="flex items-start gap-3"><i class="fa-solid fa-box text-emerald-400 text-lg mt-1 shrink-0" aria-hidden="true"></i><div><p class="text-white font-medium"><?= $lang === 'ar' ? 'صندوق البريد' : ($lang === 'fr' ? 'Boîte postale' : 'PO Box') ?></p><p class="text-emerald-200/70"><?= e(get_setting('po_box')) ?></p></div></div>
                        <div class="flex items-start gap-3"><i class="fa-solid fa-fax text-emerald-400 text-lg mt-1 shrink-0" aria-hidden="true"></i><div><p class="text-white font-medium">Fax</p><p class="text-emerald-200/70"><?= e(get_setting('fax')) ?></p></div></div>
                    </div>
                </div>
