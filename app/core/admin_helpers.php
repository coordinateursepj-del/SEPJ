...
/**
 * Get plural/collective label for a content type — used for list titles,
 * breadcrumbs, and other "section" contexts where the singular form reads
 * unnaturally in Arabic (e.g. "قائمة الصفحات" not "قائمة صفحة"). Mirrors
 * the section names already used in the sidebar for consistency.
 */
function get_content_type_label_plural(string $type, string $lang = 'ar'): string
{
    $labels = [
        'page'     => ['ar' => 'الصفحات', 'fr' => 'Pages', 'en' => 'Pages'],
        'post'     => ['ar' => 'الأخبار', 'fr' => 'Articles', 'en' => 'Posts'],
        'project'  => ['ar' => 'المشاريع', 'fr' => 'Projets', 'en' => 'Projects'],
        'service'  => ['ar' => 'الخدمات', 'fr' => 'Services', 'en' => 'Services'],
        'activity' => ['ar' => 'الأنشطة', 'fr' => 'Activités', 'en' => 'Activities'],
        'prize'    => ['ar' => 'التتويجات', 'fr' => 'Distinctions', 'en' => 'Awards'],
        'rse'      => ['ar' => 'المسؤولية المجتمعية', 'fr' => 'RSE', 'en' => 'CSR'],
        'resource' => ['ar' => 'الموارد والتنمية', 'fr' => 'Ressources', 'en' => 'Resources'],
        'sport'    => ['ar' => 'الرياضة والعمل', 'fr' => 'Sports', 'en' => 'Sports'],
        'video'    => ['ar' => 'الفيديوهات', 'fr' => 'Vidéos', 'en' => 'Videos'],
    ];
...
function get_content_page_title(string $type, string $lang, string $action = 'list'): string
{
    ...
    $titles = [
        'list'   => [
            'ar' => 'قائمة ' . get_content_type_label_plural($type, 'ar'),
...
{
    $lang = current_lang();
    // The breadcrumb link points at the type's list page, so Arabic uses the
    // plural/collective section name (matches the sidebar) instead of the
    // singular item label used elsewhere (e.g. create/edit page titles).
    $typeLabel = $lang === 'ar'
        ? get_content_type_label_plural($type, 'ar')
        : get_content_type_label($type, $lang);
