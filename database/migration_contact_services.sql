...
VALUES
    ('Gabès Sud',              'غابس الجنوب',            'Gabès South',            'gabes.sud@sepjgabes.tn',      0, 0,  10),
    ('Social',                 'الشؤون الاجتماعية',      'Social Affairs',         'social@sepjgabes.tn',         0, 0,  20),
    ('Gabès Ville',            'غابس المدينة',           'Gabès City',             'gabes.ville@sepjgabes.tn',    0, 0,  30),
    ...
    ('Gabès Ouest',            'غابس الغرب',             'Gabès West',             'gabes.ouest@sepjgabes.tn',    0, 0, 200),
